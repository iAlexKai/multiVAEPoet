...
def init_valid_loaders(valid_loader, valid_config):
    valid_loader['pos'].epoch_init(valid_config.batch_size, shuffle=False)
    valid_loader['neu'].epoch_init(valid_config.batch_size, shuffle=False)
    valid_loader['neg'].epoch_init(valid_config.batch_size, shuffle=False)
...
def valid_process(global_t, model, valid_poem_loader, valid_config, global_iter, num,
